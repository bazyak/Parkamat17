...
class RevealSuccessPlainTextFragment : Fragment() {
    ...
    private val viewModel: RevealSuccessPlainTextViewModel by lazy { (requireActivity() as AndroidScopeComponent).scope.get() }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.liveDataPlainText.observe(viewLifecycleOwner) { binding.textViewResultPlainText.text = it }
