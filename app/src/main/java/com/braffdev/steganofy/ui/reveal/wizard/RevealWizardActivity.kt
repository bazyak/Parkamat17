...
class RevealWizardActivity : AppCompatActivity(), AndroidScopeComponent {
    ...
    /**
     * Handles the close (X) button in the toolbar. Without this the button is
     * displayed but does nothing, since AppCompat has no default action for it.
     */
